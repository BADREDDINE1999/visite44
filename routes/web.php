...
Route::prefix('admin')->middleware(['auth', 'user-access:admin'])->group(function () {
    ...
    Route::get('add-rapport', [App\Http\Controllers\Admin\RapportController::class, 'create']);
    Route::post('add-rapport', [App\Http\Controllers\Admin\RapportController::class, 'store']);
    Route::get('edit-rapport/{visite_id}', [App\Http\Controllers\Admin\RapportController::class, 'edit']);
    Route::put('update-rapport/{visite_id}', [App\Http\Controllers\Admin\RapportController::class, 'update']);
